...
SECRET_KEY = 'django-insecure-b*5avop-!)0zdr+)l)(ap@)a1k0bb)*z4&hdp1g^v^i979i2+#'
...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Нужен для доступа к request.user
